...
namespace ShopApp.controllers
{
    internal class ProductController
    {
        ...
        public void removeProduct(ref List<Product> products, string id)
        {
        ...
        SelectPrice:
            ...
            price = price.Replace('.', ',');
            if (!decimal.TryParse(price, out decimal priceNumber) || priceNumber < 0)
            {
